...
class TestOrganizationResourceResponse(unittest.TestCase):
    """OrganizationResourceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationResourceResponse:
        """Test OrganizationResourceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationResourceResponse`
        """
        model = OrganizationResourceResponse()
        if include_optional:
            return OrganizationResourceResponse(
                status = True,
                message = '',
                organization = hyperstack.models.organization_resources.OrganizationResources(
                    organization_id = 56, 
                    environments = [
    ...
    def testOrganizationResourceResponse(self):
        """Test OrganizationResourceResponse"""
