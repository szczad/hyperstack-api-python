...
class TestOrganizationResources(unittest.TestCase):
    """OrganizationResources unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationResources:
        """Test OrganizationResources
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationResources`
        """
        model = OrganizationResources()
        if include_optional:
    ...
    def testOrganizationResources(self):
        """Test OrganizationResources"""
