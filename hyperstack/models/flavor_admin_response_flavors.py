...
class FlavorAdminResponseFlavors(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "openstack_id", "region_id", "region", "cpu", "ram", "disk", "ephemeral", "gpu", "gpu_count", "order", "is_public", "is_custom", "status", "organizations", "flavors", "projects", "created_at"]
