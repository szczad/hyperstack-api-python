...
class Adminpaymenthistoryresponse(BaseModel):
    ...
    payments: Optional[List[Adminpaymenthistoryfields]] = None
    __properties: ClassVar[List[str]] = ["message", "status", "payments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payments": [Adminpaymenthistoryfields.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None
        })
        return _obj
