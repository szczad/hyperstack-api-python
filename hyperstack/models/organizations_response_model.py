...
class OrganizationsResponseModel(BaseModel):
    """
    OrganizationsResponseModel
    """ # noqa: E501
    status: Optional[StrictBool] = None
    message: Optional[StrictStr] = None
    organizations: Optional[List[OrganizationInfoModel]] = None
    __properties: ClassVar[List[str]] = ["status", "message", "organizations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizations": [OrganizationInfoModel.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None
        })
        return _obj
