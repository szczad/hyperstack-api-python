...
class OrganizationResources(BaseModel):
    ...
    environments: Optional[List[EnvrionmentResources]] = None
    __properties: ClassVar[List[str]] = ["organization_id", "environments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "environments": [EnvrionmentResources.from_dict(_item) for _item in obj["environments"]] if obj.get("environments") is not None else None
        })
        return _obj
