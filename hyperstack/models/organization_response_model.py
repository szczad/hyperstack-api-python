...
class OrganizationResponseModel(BaseModel):
    ...
    organizations: Optional[OrganizationInfoModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizations": OrganizationInfoModel.from_dict(obj["organizations"]) if obj.get("organizations") is not None else None
        })
        return _obj
