...
class OrganizationInfoModel(BaseModel):
    ...
    id: StrictInt
    name: StrictStr
    users: Optional[List[OrganizationUserModel]] = None
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "name", "users", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "users": [OrganizationUserModel.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
