...
class AdminCreateContractResponseModel(BaseModel):
    ...
    contract: Optional[CreateContarctFields] = None
    __properties: ClassVar[List[str]] = ["status", "message", "contract"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contract": CreateContarctFields.from_dict(obj["contract"]) if obj.get("contract") is not None else None
        })
        return _obj
