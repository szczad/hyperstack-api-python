...
class DiscountPlanFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "resource_id", "resource_name", "resource_count", "discount_type", "discount_code", "discount_percent", "discount_amount", "discount_status"]
