...
class AdminFlavorResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "openstack_id", "name", "region_name", "cpu", "ram", "disk", "gpu", "status", "gpu_count", "stock_available", "nodes", "vms", "is_public", "is_custom", "ephemeral", "description", "created_at"]
