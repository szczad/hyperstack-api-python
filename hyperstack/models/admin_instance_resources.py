...
class AdminInstanceResources(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "openstack_id", "host", "status", "flavor", "image_id", "volume_id", "keypair_name", "fixed_ip", "floating_ip", "contract_id", "floating_ip_status", "created_at"]
