...
class OrganizationResourceList(BaseModel):
    """
    OrganizationResourceList
    """ # noqa: E501
    status: Optional[StrictBool] = None
    message: Optional[StrictStr] = None
    organizations: Optional[List[OrganizationResources]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizations": [OrganizationResources.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None
        })
        return _obj
