...
class CreditApi:
    ...
    @validate_call
    def check_balance_as_an_organization(
        self,
        ...
        _param = self._check_balance_as_an_organization_serialize(
    ...
    @validate_call
    def check_balance_as_an_organization_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def check_balance_as_an_organization_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _check_balance_as_an_organization_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
