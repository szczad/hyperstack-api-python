...
class UserPermissionApi:
    ...
    def list_current_user_permissions(
        ...
        _param = self._list_current_user_permissions_serialize(
    ...
    @validate_call
    def list_current_user_permissions_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_current_user_permissions_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_current_user_permissions_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
